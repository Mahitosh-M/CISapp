    ...
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: 'radial-gradient(circle at 50% 38%, rgba(212,175,55,0.18), transparent 30%), linear-gradient(160deg, #0F172A 0%, #11185A 48%, #4C1D95 100%)', color: '#FFFFFF', padding: 24 }}>
      ...
      <div style={{ textAlign: 'center', width: '100%', maxWidth: 360 }}>
        <div style={{ width: 132, height: 132, margin: '0 auto 22px', borderRadius: 34, background: 'rgba(255,255,255,0.08)', display: 'grid', placeItems: 'center', animation: 'medicoinsGlow 1.45s ease-in-out infinite' }}>
          <img src="/icons/icon-512.png" alt="MediCoins" style={{ width: 112, height: 112, borderRadius: 28, objectFit: 'cover' }} />
        </div>
        ...
        <div style={{ fontSize: 34, fontWeight: 900, lineHeight: 1.08 }}>MediCoins</div>
