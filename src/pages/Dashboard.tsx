...
const Dashboard = () => {
  ...
  const businessInvoices = useMemo(() => getBusinessInvoices(invoices), [invoices]);
  const periodInvoices = useMemo(() => {
    return businessInvoices.filter((invoice) => isDateInRange(invoice.date, activeFromDate, activeToDate));
  }, [activeFromDate, activeToDate, businessInvoices]);
