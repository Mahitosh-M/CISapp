                ...
                <div key={reward.id} style={customerPromoCardStyle}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center' }}>
                    <div>
                      ...
                      <div style={{ display: 'inline-flex', alignItems: 'center', background: '#FFF7D6', color: '#11185A', borderRadius: 999, padding: '5px 9px', fontSize: 11, fontWeight: 900, marginTop: 7 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: isGifted ? '#166534' : isRequested || !hasEnoughApc ? '#67738E' : '#11185A',
                        padding: '10px 12px',
                        fontWeight: 900,
